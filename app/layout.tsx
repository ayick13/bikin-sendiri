                ...
                <div className="footer-credits">
                  ...
                  <div className="credit-category">
                    ...
                    <div className="credit-items">
                      ...
                      <a href="https://next-auth.js.org/" target="_blank" rel="noopener noreferrer" className="tech-item"><Shield size={14}/> NextAuth.js</a>
                      <a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer" className="tech-item"><Wind size={14}/> Tailwind CSS</a>
                      ...
                      <a href="https://lucide.dev/" target="_blank" rel="noopener noreferrer" className="tech-item"><Wand size={14}/> Lucide Icons</a>
                    </div>
                  </div>
                  <div className="credit-category">
                    ...
                    <div className="credit-items">
                      ...
                      <a href="https://pnpm.io/" target="_blank" rel="noopener noreferrer" className="tech-item"><Package size={14}/> pnpm</a>
                      <a href="https://eslint.org/" target="_blank" rel="noopener noreferrer" className="tech-item"><CheckCircle size={14}/> ESLint</a>
                      <a href="https://prettier.io/" target="_blank" rel="noopener noreferrer" className="tech-item"><Paintbrush size={14}/> Prettier</a>
                    </div>
                  </div>
                </div>
              </footer>
